...
function PricingBox({ img, price, category }) {
  return (
    <>
      <div className="flex flex-col w-1/3 md1000:w-[400px] bg-white shadow-xl relative min540:w-[100%]">
        <div style={{ transition: "all 0.3s" }} className="relative grayscale hover:grayscale-0">
          ...
          <div className="absolute bg-white text-[20px] font-bold w-[250px] text-center py-6 text-[#ff0336] -bottom-[18px] left-0 right-0 mx-auto rounded-lg">
            {category}
          </div>
        </div>
